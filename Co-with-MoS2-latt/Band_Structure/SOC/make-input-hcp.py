...
update_keyword( pwscf.atomic_species, 'mass', mass_Co )
update_keyword( pwscf.atomic_species, 'pseudo_potential', pseudo_potential_Co )
...
update_keyword( pwscf.system.structure, 'nat', 1)
update_keyword( pwscf.system.structure, 'ntyp', 1)
