...
update_keyword( pwscf.control.io, 'disk_io', 'med')
...
update_keyword( pwscf.system.occupations,'occupations', 'tetrahedra')
...
for val in grid:
    update_keyword( pwscf.kpoints, 'mesh', [12*val,12*val,1] )
    ...
    out_filename = f"nscf_{12*val}.inp"
